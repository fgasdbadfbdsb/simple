...
try {
  ...
  $mail->Username   = 'andrew1202volkov@yandex.ru'; // Логин на почте
  $mail->Password   = 'A16021880rsmpj'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('andrew1202volkov@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('andrew1202volkov@yandex.ru');
